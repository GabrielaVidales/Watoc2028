export function getCountryImage(country) {
    const target = countries.find(item => item.label === country || item.code === country)
    if (target)
        return <img
            loading="lazy"
            width="20"
            srcSet={`https://flagcdn.com/w40/${target.code.toLowerCase()}.png 2x`}
            src={`https://flagcdn.com/w20/${target.code.toLowerCase()}.png`}
            alt=""
        />;
    return null
}
