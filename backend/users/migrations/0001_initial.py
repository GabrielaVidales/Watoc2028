# Generated by Django 6.0 on 2026-02-24 20:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation_letter', models.FileField(blank=True, default=None, null=True, upload_to='users/photos/')),
        ...
        migrations.CreateModel(
            name='Dinner',
            fields=[
                ('participant', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='users.participant')),
            ],
        ),
    ]
