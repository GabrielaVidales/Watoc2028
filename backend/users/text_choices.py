...
class Nationality(TextChoices):
    ...
    COCOS_ISLANDS = "CC", _("Cocos (Keeling) Islands")
    ...
    PITCAIRN_ISLANDS = "PN", _("Pitcairn Islands")
    POLAND = "PL", _("Poland")
    ...
    RUSSIA = "RU", _("Russia")
    RWANDA = "RW", _("Rwanda")
    SAINT_HELENA = "SH", _("Saint Helena")
    ...
    SERBIA_AND_MONTENEGRO = "CS", _("Serbia and Montenegro")
    ...
    SOUTH_GEORGIA_AND_SOUTH_SANDWICH_ISLANDS = "GS", _("South Georgia and South Sandwich Islands")
    SPAIN = "ES", _("Spain")
